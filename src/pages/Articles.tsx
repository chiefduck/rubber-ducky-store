    ...
    <div className="absolute top-2 right-2 bg-ducky-red text-white text-xs font-bold py-1 px-2 rounded">
      Featured
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <Button variant="outline" className="w-full mt-auto border-ducky-red text-ducky-red hover:bg-ducky-red/10 group-hover:bg-ducky-red group-hover:text-white transition-colors">
                      Read More
                    </Button>
                  </div>
                </div>
